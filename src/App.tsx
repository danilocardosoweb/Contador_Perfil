...
export default function App() {
  ...
  return (
    <div className="flex h-screen flex-col bg-slate-950 text-slate-300 overflow-hidden font-sans">
      <header className="h-14 border-b border-slate-800 bg-slate-900/50 flex shrink-0 items-center justify-between px-6">
        <div className="flex items-center gap-3">
          ...
          <h1 className="font-bold text-lg tracking-tight text-white">
            ALU-SCAN <span className="text-sky-400">VISION</span>
          </h1>
      ...
      <main className="flex-1 flex overflow-hidden">
        {activeTab === 'camera' ? (
          <div className="flex flex-1 flex-col lg:flex-row">
            <div className="flex-1 bg-black relative border-r border-slate-800 p-4">
            ...
            <div className="w-full lg:w-80 xl:w-[400px] border-l border-slate-800 bg-slate-900 overflow-y-auto">
              <ControlsPanel 
                params={params} 
                onChange={setParams} 
                lastCount={lastCount}
